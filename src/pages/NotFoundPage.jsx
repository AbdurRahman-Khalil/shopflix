...
export const NotFoundPage = () => {
    ...
    return (
        <section id="not-found-page" className="relattive min-h-dvh duration-200 ease-linear">
            <div className="absolute inset-0 flex items-center justify-center bg-neutral-50/40 dark:bg-neutral-900/40 backdrop-blur-xl px-5 md:px-10 duration-200 ease-linear">
