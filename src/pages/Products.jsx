...
export const Products = () => {
    return (
        <section id="products" className="mb-[3.75rem] px-5 md:px-10 xl:mx-auto xl:container">
            ...
            <ul className="list-none max-[618px]:relative 
                    max-[618px]:before:absolute before:top-16 before:-right-[0.2rem] before:w-[1.3rem] before:h-[35%] before:bg-gradient-to-r before:from-transparent before:to-neutral-50 dark:before:to-neutral-900
                    max-[618px]:after:absolute after:top-16 after:-left-[0.2rem] after:w-[1.3rem] after:h-[35%] after:bg-gradient-to-l after:from-transparent after:to-neutral-50 dark:after:to-neutral-900"
            >
                <SearchBar />
                <div className="max-[618px]:overflow-x-scroll">
                    <div className="flex items-center gap-7 font-medium my-[1.35rem]">
                        <MenuLink
                            destination={"/products/all"}
                            menuLinkText={"All"}
                            addStyles={"font-medium dark:font-light text-neutral-800/70 dark:text-neutral-100/70 max-[618px]:pl-2 min-[619px]:pl-0.5"}
                        ...
                        <MenuLink
                            ...
                            addStyles={"font-medium dark:font-light text-neutral-800/70 dark:text-neutral-100/70 max-[618px]:pr-2"}
                            activeStyles={"text-neutral-950 dark:text-neutral-50 font-semibold dark:font-medium"}
                        />
                    </div>
                </div>
